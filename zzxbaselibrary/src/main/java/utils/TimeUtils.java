...
/**
 * Created by zzx on 2017/12/7 0007.
 */
...
public class TimeUtils {
     ...
     */
    public boolean compareNowTime(String time, DateUtils.DatePattern datePattern) {
        boolean isDayu = false;

        SimpleDateFormat dateFormat = new SimpleDateFormat(datePattern.getValue());
     ...
     */
    public boolean compareTwoTime(String starTime, String endString, DateUtils.DatePattern datePattern) {
        boolean isDayu = false;
        SimpleDateFormat dateFormat = new SimpleDateFormat(datePattern.getValue());
