...
public class SpannableStringUtils {
    ...
    public static class Builder {
         ...
         * @return {@link Builder}
         */
        public Builder setForegroundColor(@ColorInt int color, String key) {
            this.foregroundColor = color;
            this.key = key;
            return this;
        }
         ...
         * @return {@link Builder}
         */
        public Builder setForegroundColor(@ColorInt int[] color, String[] keys) {
            this.foregroundColors = color;
            this.keys = keys;
            return this;
        }
        ...
        private void setSpan() {
            ...
            if (foregroundColor != defaultValue || foregroundColors != null) {
                if (key != null && text.toString().contains(key)) {
                    int indexOf = text.toString().indexOf(key);
                    mBuilder.setSpan(new ForegroundColorSpan(foregroundColor), indexOf, key.length() + indexOf, flag);
                } else if (keys != null && keys.length > 0) {
                    for (int i = 0; i < keys.length; i++) {
                        int indexOf = text.toString().indexOf(keys[i]);
                        mBuilder.setSpan(new ForegroundColorSpan(foregroundColors[i]), indexOf, keys[i].length() + indexOf, flag);
                    }
                } else {
