...
public class StickyHeaderDecoration extends RecyclerView.ItemDecoration {
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        if (!mIncludeHeader) {
            if (parent.getAdapter() instanceof ZRecyclerViewAdapter) {
                int headerCount = ((ZRecyclerViewAdapter) parent.getAdapter()).getHeaderCount();
                int footerCount = ((ZRecyclerViewAdapter) parent.getAdapter()).getFooterCount();
                int dataCount = ((ZRecyclerViewAdapter) parent.getAdapter()).getDataCount();
