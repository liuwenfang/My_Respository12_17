...
public class DividerDecoration extends RecyclerView.ItemDecoration {
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        if (parent.getAdapter() instanceof ZRecyclerViewAdapter) {
            headerCount = ((ZRecyclerViewAdapter) parent.getAdapter()).getHeaderCount();
            footerCount = ((ZRecyclerViewAdapter) parent.getAdapter()).getFooterCount();
        }
    ...
    public void onDrawOver(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        if (parent.getAdapter() instanceof ZRecyclerViewAdapter) {
            headerCount = ((ZRecyclerViewAdapter) parent.getAdapter()).getHeaderCount();
            footerCount = ((ZRecyclerViewAdapter) parent.getAdapter()).getFooterCount();
            dataCount = ((ZRecyclerViewAdapter) parent.getAdapter()).getDataCount();
        } else {
