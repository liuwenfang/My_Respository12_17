 ...
 */
final public class ZActivityStack {
    private static Stack<Activity> activityStack;
    private static final ZActivityStack instance = new ZActivityStack();

    private ZActivityStack() {
    }

    public static ZActivityStack getInstance() {
        return instance;
    }
