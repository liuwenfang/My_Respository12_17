...
public class XLoadingView extends FrameLayout {
    ...
    public XLoadingView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mEmptyViewResId = a.getResourceId(R.styleable.LoadingView_emptyView, config.getEmptyViewResId());
        mErrorViewResId = a.getResourceId(R.styleable.LoadingView_errorView, config.getErrorViewResId());
        mLoadingViewResId = a.getResourceId(R.styleable.LoadingView_loadingView, config.getLoadingViewResId());
        mNoNetworkViewResId = a.getResourceId(R.styleable.LoadingView_noNetworkView, config.getNoNetworkViewResId());
        a.recycle();
    }
    ...
    private View layout(int resId) {
        ...
        if (resId == mErrorViewResId || resId == mEmptyViewResId || resId == mNoNetworkViewResId) {
